...
<html>
    ...
    <body>
        ...
        <br>Teams from the first tournament.</br>
        <table>
            <tr>
                <th>Team Name</th>
            ...
            <tr>
                <td>Ben Simmons isn't a rookie</td>
                <td>Derek</td>
                <td>Trevor</td>
            </tr>
            <tr>
                <td>Orbtuze</td>
                <td>oJudah</td>
                <td>dropthecupcake</td>
            </tr>
            <tr>
                <td>Backshot hooligans</td>
                <td>Joel Duarte</td>
                <td>Jonah Contapay</td>
            </tr>
            <tr>
                <td>Goon Squad</td>
                <td>oKingM8</td>
            ...
            <tr>
                <td>A1</td>
                <td>Killer_kid450</td>
                <td>ITz_BEASTY310776</td>
            </tr>
            <tr>
                <td>Hillside Squad</td>
                <td>xxBravo27xx</td>
                <td>xxbravo23xx</td>
            </tr>
            <tr>
                <td>Diehard Tryhards</td>
                <td>Weapn_of_death7</td>
                <td>Beretta209</td>
            </tr>
            <tr>
                <td>600</td>
